 ...
 * });
 */
public class TTSAutoCheck {

    private static TTSAutoCheck instance;
     ...
     * @return
     */
    public static TTSAutoCheck getInstance(Context context) {
        if (instance == null || TTSAutoCheck.context != context) {
            instance = new TTSAutoCheck(context);
        }
        return instance;
    }
    ...
    public void check(final InitConfig initConfig, final Handler handler) {
        Thread t = new Thread(new Runnable() {
            @Override
            public void run() {
                TTSAutoCheck obj = innerCheck(initConfig);
                isFinished = true;
    ...
    private TTSAutoCheck innerCheck(InitConfig config) {
    ...
    private TTSAutoCheck(Context context) {
